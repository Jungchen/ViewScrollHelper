...
public class ViewScrollHelper {
  ...
  private final RecyclerView.OnScrollListener recyclerViewScrollListener =
      new RecyclerView.OnScrollListener() {
        @Override public void onScrollStateChanged(RecyclerView recyclerView, int newScrollState) {
  ...
  private final ObservableScrollViewListener observableScrollViewListener =
      new ObservableScrollViewListener() {
        @Override public void onScrollStateChanged(ScrollView scrollView, int newScrollState) {
          if (enabled && newScrollState == ObservableScrollView.SCROLL_STATE_IDLE) {
            checkScrollStateChanged();
          }
        }

        @Override public void onScrolled(ScrollView scrollView, int dx, int dy) {
          if (enabled) {
            checkOnScrolled(dy);
          }
        }

        @Override public void onScrollPositionChanged(float posx, float posy) {
        }
